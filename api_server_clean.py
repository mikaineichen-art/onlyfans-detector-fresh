#!/usr/bin/env python3
"""
Clean Flask API Server for OnlyFans Detector
Railway-compatible version without complex dependencies
"""
...
import asyncio
import logging
from onlyfans_detector_clean import detect_onlyfans_in_bio_link
...
def health_check():
    ...
    return jsonify({
        "status": "healthy",
        "service": "OnlyFans Detector API (Clean)",
        "version": "1.0.0"
    })
